        ...
        <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
            ...
            <form class="navbar-form " role="search">
                <div class="navbar-left">
                    <a href="<?php echo U('index');?>"><button type="button" class="btn btn-default">查看正常账号</button></a>
                    <button type="button" class="btn btn-primary">查看被锁定账号</button>
                </div>
                    ...
                    <div style="height:400px;">
                        <table class="table table-striped table-bordered">
                            ...
                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td><a href="#" class="btn-account" value="<?php echo ($vo["id"]); ?>">账号信息</a>|<a href="#" class="btn-person" value="<?php echo ($vo["id"]); ?>">学生信息</a></td>
                                    <td><a href="#" class="btn-unlock" value="<?php echo ($vo["id"]); ?>">解除锁定</a></td>
...
<script type="text/javascript">
    $(function() {
        ...
        $('.btn-unlock').click(function() {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo U('unlockOneAccount');?>",
                data: {
                    id: id
                },
                cache: false,
        ...
        $('#btn-search').click(function(){
            ...
            location.href = '<?php echo U('locked');?>?searchinfo='+searchinfo;
        });
    });
</script>
