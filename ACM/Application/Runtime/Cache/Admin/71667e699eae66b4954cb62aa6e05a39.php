                    ...
                    <div style="height:350px;">
                        <table class="table table-striped table-bordered">
                            ...
                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td><a href="#" class="btn-admin-info" value="<?php echo ($vo["id"]); ?>">账号信息</a>|<a href="#" class="btn-mod-info" value="<?php echo ($vo["id"]); ?>">修改信息</a></td>
                                    <td><a href="#" class="btn-del-admin" value="<?php echo ($vo["id"]); ?>">删除</a></td>
...
<script type="text/javascript">
    $(function() {
        ...
        $('.btn-admin-info').click(function() {
            ...
            $.ajax({
                type: "get",
                url: "<?php echo U('returnOneAdminInfo');?>",
                data: {
                    id: id
                },
                cache: false,
